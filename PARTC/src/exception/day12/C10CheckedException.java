...
// 체트 예외: 컴파일러가 처리를 강제하는 예외. 
//       ㄴ  사용하는 클래스 안에서 예외를 발생시켰기 때문에 
//       ㄴ  Unhandled exception type IOExceptio 는 반드시 예외처리 필요하드는 메시지 입니다.
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            if(file.exists()){
                ...
                System.out.println("파일의 길이 :" + file.length()); // 바이트 
            }else {
            ...
            // file.createNewFile() 메소드가 체크 익셉션을 발생시켰다.
            //         ㄴ 반드시 예외처리가 필요하다. 
