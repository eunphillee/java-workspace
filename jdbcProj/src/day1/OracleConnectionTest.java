...
public class OracleConnectionTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            // jdk 8 이전에는 직접 오라클 드라이버 로드 코딩 해야합니다. 
            ...
            // 오라클 드라이버에 포함된 클래스 oracle.jdbc.driver.T4CConnection
        } catch (Exception e) {
 ...
 *          ㄴ 인터페이스는 객체를 직접 만들 수 엇습니다. 구현클래스를 통해서 객체가 만들어집니다.
 *          ㄴ jdbc 에서는 DriverMasnager로 드라이버가 메모리에 로딩되면
 *              필요한 구현 클래스와 객체생성은 드라이버로 만들어집니다. 
