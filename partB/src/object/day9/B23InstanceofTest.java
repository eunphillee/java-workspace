...
public class B23InstanceofTest {
    // 부모타입으로 업캐스팅된 자식 타입의 객체를 검사 => 다운캐스팅 클래스탑을 결정 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sh1 instanceof Triangle :" + (sh2 instanceof Triangle));
        System.out.println("sh1 instanceof Triangle :" + (sh3 instanceof Triangle));
        System.out.println("sh1 instanceof Triangle :" + (sh4 instanceof Triangle));
        ...
        Triangle tri=null;   // if 조건이 거짓이면 tri 출력문 오류. 초기화 안되었음 
                                                            // => null 초기화 필용
    ...
    // 인자로 전달된 도형이 Circle 객체인지 검사하는 메소드 (참, 거짓 리턴)

    public static boolean isCircle(Shape shape){ // 퀴즈  () 안에 인자 선언은 ? 
