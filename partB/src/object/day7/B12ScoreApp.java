...
public class B12ScoreApp {
    ...
    public static void main(String[] args) {
        // Score 클래스로 만들어진 객체들을 참조하기 위한 배열을 선언.
        ...
        while (run) {
            ...
            System.out.println("=====점수 통게 (점수 합계와 평균)==========");
            ...
            for( Score temp : stuScores){   // 설명: 
                ...
                if(temp!=null){        // 조건식 없이 누적 합계 식 실행하면 오류. 가져온 참조값이 null 이 아닌지 검사
