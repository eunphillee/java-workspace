...
public class B03MyMathTest {
    ...
    public static void main(String[] args) {
        ...
        MyMath myMath = new MyMath();// 객체 생성 
        ...
        System.out.println("===새로운 객체 생성2====");
        MyMath myMath3 = new MyMath(); 
        myMath3.first = 5555;
        myMath3.second = 55;
        System.out.println(myMath3.mathToString(MyMath.ADD));
        System.out.println(myMath3.mathToString(MyMath.SUB));
        System.out.println(myMath3.mathToString(MyMath.MUL));
        ...
        System.out.println("myMath.add() :"+ temp.add());  // 0 
        System.out.println("myMath.substract() :"+ temp.substract()); //0 
