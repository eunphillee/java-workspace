...
// -> 자바 JDK 는 아래 4개 유형의 인터페이스가 이미 만들어져 있고 사용함 하면 됩니다.
// 1. Runnalbe   - 실행할 수 있는    run()
// 2. Consumer   - 소비자 (인자만 가져가 사용한다.)
// 3. Supplier   - 공급자 (인자 없이 리턴을 준다.)
// 4. Function   - 인자값을 갖고 처리결과를 리턴하는 함수 
