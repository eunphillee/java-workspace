...
public class A26ArraysMethod {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("모든요소를 특정 값으로 저장하기)");
        Arrays.fill(arr2, 111);   // 리턴이 없고 arr2 값을 변경 
        System.out.println("arr2 :" +Arrays.toString(arr2));
        ...
        Arrays.sort(newarr);    //리턴이 없고 newarr 값을 변경 
        ...
        // 6. 배열 요소 값 찾기 : 리턴값이 0보다 크거나 같을 때만 찿기 성공
        int index = Arrays.binarySearch(newarr, 540);
        System.out.println("6. 배열 요소의 인텍스 찾기)");
        System.out.println("binarySearch(arr1, 540)" + index);
        System.out.println("binarySearch(arr1, 550)" 
        ...
        System.out.println(Arrays.mismatch(arr1, new int[]{110,620,930,550,250,880}));  
