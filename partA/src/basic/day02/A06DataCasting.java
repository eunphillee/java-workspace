...
// 캐싱팅 (casting) : 데이터의 형식 변환 
        //   ㄴ 강제 캐스팅: 변수 앞에 () 기호에 바구려는 데이터 타입 키워드
        // 데이터의 범위를 순서대로 나열: byte < short < int < long < float < double 
        //   ㄴ 자동 캐스팅 : 텀블러가 350ml 용량, 구입한 커피 200ml 
public class A06DataCasting {
    public static void main(String[] args) {
        ...
        // 정수를 예시로 들면 정수는 기본 타입이 int. 23은 둘다 int
         ...
         // 정수  int의 가장 마자막 값 : 2,147,483,647
         //             2147483648은 int에 정장 못함. (오버플로우)

         long lnum = 2147483648L;    
         // int 범위를 넘어가는 정수는 long에 저장하기 위해 리터럴 기호 L(l) 표기
         ...
         float f2 = 23;
         double d2 = 23;
         double d3 = 2147843648L;
         //byte < short < int < long < float < double 

         // d1 을 a 라는 int 변수에 저장하고 출력하기 : 강제 캐스팅
          a = (int)d1;
          System.out.println("d1의 값 3.1419를 int로 하면 " +a);
          // 강제 캐스팅은 데이터 손실이 발생할 수 있습니다. 
