...
public class A28ArrayReview {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("정수 배열 dArr :" + dArr); // [D@85ede7b
        System.out.println("정수 배열 cArr :" + cArr); // [C@5674cd4d
        ...
        System.out.println("iArr 의 요소 개수(길이) : " +dArr.length);
        System.out.println("iArr 의 요소 개수(길이) : " +cArr.length);
        ...
        cArr = temp; //같은 타입의 배열일 때 대입문. 2개 변수 모두 char[]

        System.out.println("cArr = temp 의 결과-------------");
